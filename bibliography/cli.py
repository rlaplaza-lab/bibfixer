...
# import cleanup routines relocated from the legacy CLI
from .fixes import (
...
def update_with_betterbib(bib_file):
    ...
    # betterbib sometimes leaves entries commented out; use the shared
    # helper rather than duplicating the logic here.  the function already
    # prints its own reporting message.
...
# implementation moved to bibliography/fixes.py; imported at module top
